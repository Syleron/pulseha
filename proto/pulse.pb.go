...
type ServerClient interface {
	...
	Status(ctx context.Context, in *PulseStatus, opts ...grpc.CallOption) (*PulseStatus, error)
	// demote
	RpcMakePassive(ctx context.Context, in *PulsePromote, opts ...grpc.CallOption) (*PulsePromote, error)
	RpcBringUpIp(ctx context.Context, in *PulseBringIP, opts ...grpc.CallOption) (*PulseBringIP, error)
	RpcBringDownIp(ctx context.Context, in *PulseBringIP, opts ...grpc.CallOption) (*PulseBringIP, error)
}
...
func (c *serverClient) RpcMakePassive(ctx context.Context, in *PulsePromote, opts ...grpc.CallOption) (*PulsePromote, error) {
	out := new(PulsePromote)
	err := grpc.Invoke(ctx, "/proto.Server/RpcMakePassive", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serverClient) RpcBringUpIp(ctx context.Context, in *PulseBringIP, opts ...grpc.CallOption) (*PulseBringIP, error) {
	out := new(PulseBringIP)
	err := grpc.Invoke(ctx, "/proto.Server/RpcBringUpIp", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serverClient) RpcBringDownIp(ctx context.Context, in *PulseBringIP, opts ...grpc.CallOption) (*PulseBringIP, error) {
	out := new(PulseBringIP)
	err := grpc.Invoke(ctx, "/proto.Server/RpcBringDownIp", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ServerServer interface {
	...
	Status(context.Context, *PulseStatus) (*PulseStatus, error)
	// demote
	RpcMakePassive(context.Context, *PulsePromote) (*PulsePromote, error)
	RpcBringUpIp(context.Context, *PulseBringIP) (*PulseBringIP, error)
	RpcBringDownIp(context.Context, *PulseBringIP) (*PulseBringIP, error)
}
...
func _Server_RpcMakePassive_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PulsePromote)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ServerServer).RpcMakePassive(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.Server/RpcMakePassive",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServerServer).RpcMakePassive(ctx, req.(*PulsePromote))
	}
	return interceptor(ctx, in, info, handler)
}

func _Server_RpcBringUpIp_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PulseBringIP)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ServerServer).RpcBringUpIp(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.Server/RpcBringUpIp",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServerServer).RpcBringUpIp(ctx, req.(*PulseBringIP))
	}
	return interceptor(ctx, in, info, handler)
}

func _Server_RpcBringDownIp_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PulseBringIP)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ServerServer).RpcBringDownIp(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.Server/RpcBringDownIp",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServerServer).RpcBringDownIp(ctx, req.(*PulseBringIP))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Server_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RpcMakePassive",
			Handler:    _Server_RpcMakePassive_Handler,
		},
		{
			MethodName: "RpcBringUpIp",
			Handler:    _Server_RpcBringUpIp_Handler,
		},
		{
			MethodName: "RpcBringDownIp",
			Handler:    _Server_RpcBringDownIp_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "proto/pulse.proto",
...
var fileDescriptor0 = []byte{
	...
	,
}
