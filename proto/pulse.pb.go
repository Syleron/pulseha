...
type PulseGroupList struct {
	Success bool              `protobuf:"varint,1,opt,name=success" json:"success,omitempty"`
	Message string            `protobuf:"bytes,2,opt,name=message" json:"message,omitempty"`
	Groups  map[string]string `protobuf:"bytes,3,rep,name=groups" json:"groups,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
}
...
func (m *PulseGroupList) GetGroups() map[string]string {
	if m != nil {
		return m.Groups
	}
	return nil
...
var fileDescriptor0 = []byte{
	...
	,
}
