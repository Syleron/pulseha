...
type MemberlistMember struct {
	...
	FoCount      int32               `protobuf:"varint,5,opt,name=fo_count,json=foCount" json:"fo_count,omitempty"`
	FoTime       string              `protobuf:"bytes,6,opt,name=fo_time,json=foTime" json:"fo_time,omitempty"`
}
...
func (m *MemberlistMember) GetFoCount() int32 {
	if m != nil {
		return m.FoCount
	}
	return 0
...
func (m *MemberlistMember) GetFoTime() string {
	if m != nil {
		return m.FoTime
	}
	return ""
...
var fileDescriptor0 = []byte{
	...
	,
}
